...
const (
	...
	HandlerService_GetInboundConf_FullMethodName   = "/v2ray.core.app.proxyman.command.HandlerService/GetInboundConf"
	HandlerService_GetOutboundConf_FullMethodName  = "/v2ray.core.app.proxyman.command.HandlerService/GetOutboundConf"
	HandlerService_ListInboundConf_FullMethodName  = "/v2ray.core.app.proxyman.command.HandlerService/ListInboundConf"
	HandlerService_ListOutboundConf_FullMethodName = "/v2ray.core.app.proxyman.command.HandlerService/ListOutboundConf"
)
...
func (c *handlerServiceClient) GetInboundConf(ctx context.Context, in *GetInboundConfRequest, opts ...grpc.CallOption) (*GetInboundConfResponse, error) {
	...
	err := c.cc.Invoke(ctx, HandlerService_GetInboundConf_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *handlerServiceClient) GetOutboundConf(ctx context.Context, in *GetOutboundConfRequest, opts ...grpc.CallOption) (*GetOutboundConfResponse, error) {
	...
	err := c.cc.Invoke(ctx, HandlerService_GetOutboundConf_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *handlerServiceClient) ListInboundConf(ctx context.Context, in *ListInboundConfRequest, opts ...grpc.CallOption) (*ListInboundConfResponse, error) {
	...
	err := c.cc.Invoke(ctx, HandlerService_ListInboundConf_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *handlerServiceClient) ListOutboundConf(ctx context.Context, in *ListOutboundConfRequest, opts ...grpc.CallOption) (*ListOutboundConfResponse, error) {
	...
	err := c.cc.Invoke(ctx, HandlerService_ListOutboundConf_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _HandlerService_GetInboundConf_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: HandlerService_GetInboundConf_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _HandlerService_GetOutboundConf_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: HandlerService_GetOutboundConf_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _HandlerService_ListInboundConf_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: HandlerService_ListInboundConf_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _HandlerService_ListOutboundConf_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: HandlerService_ListOutboundConf_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
